...
Now, we can have some _external_ parameters to our function that are provided
...
This can be useful both for the project you're working on _now_ as well as the
project you'll be working on _in the future_.
...
an instance of an object. Note that they do not _have_ to be pre-declared.
